import{_ as e,r as t,o,c as p,a as l,b as n,d as i,w as c,e as s}from"./app-w9FD6_In.js";const u="/image/2024032308.jpg",r="/image/2024032309.jpg",d={},v=s('<h2 id="_654-最大二叉树" tabindex="-1"><a class="header-anchor" href="#_654-最大二叉树" aria-hidden="true">#</a> 654. 最大二叉树</h2><p>给定一个不重复的整数数组 <code>nums</code> 。 <strong>最大二叉树</strong> 可以用下面的算法从 <code>nums</code> 递归地构建:</p><p>创建一个根节点，其值为 <code>nums</code> 中的最大值。 递归地在最大值 <strong>左边</strong> 的 <strong>子数组前缀上</strong> 构建左子树。 递归地在最大值 <strong>右边</strong> 的 <strong>子数组后缀上</strong> 构建右子树。 返回 <code>nums</code> 构建的 <em><strong>最大二叉树</strong></em> 。</p><p>示例 1： <img src="'+u+`" alt=""></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：nums = [3,2,1,6,0,5]
