import{_ as n,o as s,c as a,e}from"./app-jS-C7GC1.js";const t="/image/2024032204.jpg",p={},o=e('<h2 id="_404-左叶子之和" tabindex="-1"><a class="header-anchor" href="#_404-左叶子之和" aria-hidden="true">#</a> 404. 左叶子之和</h2><p>给定二叉树的根节点 <code>root</code> ，返回所有左叶子之和。</p><p>示例 1： <img src="'+t+`" alt=""></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入: root = [3,9,20,null,null,15,7] 
输出: 24 
