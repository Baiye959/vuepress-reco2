import{_ as n,o as s,c as a,e}from"./app-CSCmXqsF.js";const t="/image/2024032201.jpg",p="/image/2024032202.jpg",o={},l=e('<h2 id="_110-平衡二叉树" tabindex="-1"><a class="header-anchor" href="#_110-平衡二叉树" aria-hidden="true">#</a> 110. 平衡二叉树</h2><p>给定一个二叉树，判断它是否是 <strong>平衡二叉树</strong> (平衡二叉树 是指该树所有节点的左右子树的深度相差不超过 1。)</p><p>示例 1： <img src="'+t+`" alt=""></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：root = [3,9,20,null,null,15,7]
输出：true
