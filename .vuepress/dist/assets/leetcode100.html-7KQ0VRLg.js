import{_ as n,o as s,c as a,e}from"./app-mhGap3UT.js";const t="/image/2024032014.jpg",p="/image/2024032015.jpg",l="/image/2024032016.jpg",o={},i=e('<p>给你两棵二叉树的根节点 <code>p</code> 和 <code>q</code> ，编写一个函数来检验这两棵树是否相同。</p><p>如果两个树在结构上相同，并且节点具有相同的值，则认为它们是相同的。</p><p>示例 1： <img src="'+t+`" alt=""></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：p = [1,2,3], q = [1,2,3]
输出：true
