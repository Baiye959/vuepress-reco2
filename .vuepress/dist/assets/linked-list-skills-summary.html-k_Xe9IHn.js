import{_ as n,o as s,c as a,e as p}from"./app-jiLvWxPd.js";const t="/image/2024091101.png",e="/image/2024091102.png",o={},c=p(`<h2 id="合并两个有序链表-力扣第-21-题「合并两个有序链表」" tabindex="-1"><a class="header-anchor" href="#合并两个有序链表-力扣第-21-题「合并两个有序链表」" aria-hidden="true">#</a> 合并两个有序链表（力扣第 21 题「合并两个有序链表」）</h2><p><strong>当你需要创造一条新链表的时候，可以使用虚拟头结点简化边界情况的处理。</strong></p><p>两个有序链表合并为一个有序链表，只需比较当前头结点，谁小谁加入结果链表即可。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
