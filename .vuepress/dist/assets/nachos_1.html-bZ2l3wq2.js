...
./nachos
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实现双向有序链表" tabindex="-1"><a class="header-anchor" href="#实现双向有序链表" aria-hidden="true">#</a> 实现双向有序链表</h2><p>实现双向链表不难，可以参考<code>code/threads</code>目录里的<code>list.cc</code>和<code>list.h</code>，主要是熟悉 UNIX编程环境、make与makefile的用法和c++编程</p>`,7),m={href:"http://t.csdnimg.cn/SvuqF",target:"_blank",rel:"noopener noreferrer"},v=n("code",null,'#include "utility.h"',-1),b=n("code",null,"#include <iostream>",-1),k=a('<p><img src="'+d+`" alt=""></p><p>测试双向链表的<code>main.cc</code>如下</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#include &lt;iostream&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试成功 <img src="`+r+'" alt=""></p><h2 id="体验nachos线程系统" tabindex="-1"><a class="header-anchor" href="#体验nachos线程系统" aria-hidden="true">#</a> 体验nachos线程系统</h2><h3 id="nachos源代码阅读" tabindex="-1"><a class="header-anchor" href="#nachos源代码阅读" aria-hidden="true">#</a> nachos源代码阅读</h3>',6);function _(g,f){const e=t("ExternalLinkIcon");return c(),o("div",null,[p,h,n("p",null,[s("这里遇到一个奇怪的报错，解决方法参考链接"),n("a",m,[s("[nachos]stdlib.h和sysdep.h冲突了？？"),l(e)]),s("，在"),v,s("之前要先"),b]),k])}const L=i(u,[["render",_],["__file","nachos_1.html.vue"]]);export{L as default};
